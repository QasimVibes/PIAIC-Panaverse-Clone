  ...
  return (
    <>
      ...
      <main>
        ...
        <p>
          <Image
            src={"/assets/red-p-logo-text_dao_croped.png"}
        ...
        <h2>
          ...
          is a community of Web 3 and Metaverse developers, designers, trainers,
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/videoseries?si=OWK2NYc9sNH4H--y&amp;list=PLKvqnz8z1zWQ3BALy86tIXICkG874wAc6"
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/videoseries?si=ga-gpIb4aZuHLq5t&amp;list=PLKvqnz8z1zWQSWIen_zUSEBmtqzPLuRob"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        </div>
        <h3>Web 3.0 and Metaverse Theory</h3>
        <p>
        ...
        <div className="youtube-videos">
          <p>Learn JavaScript by Zeeshan Hanif (Watch Recorded Videos)</p>
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/videoseries?si=b3AcMeRyN4TquG-V&amp;list=PLKvqnz8z1zWQdc0NSLknxmxBch5gLOqyo"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
        ...
        <p>
          <a href="https://www.amazon.com/JavaScript-Beginner-Professional-building-interactive/dp/1800562527/ref=sr_1_4">
            ...
            JavaScript quickly by building fun, interactive, and dynamic web
            apps, games, and pages
          </a>
        </p>
        <p>
        ...
        <h3>Object-Oriented Programming with TypeScript</h3>
        <p>
        ...
        <h3>TypeScript Quizzes</h3>
        <p>Fundamentals of TypeScript Quiz</p>
        <p>TypeScript Professional Proficiency Quiz</p>
        <h3>Fundamentals of Version Control with Git (Recorded Videos)</h3>
        <div className="youtube-videos">
          <p>Version Control using Git and GitHub By Sir Zeeshan Hanif</p>
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/videoseries?si=WUIaC8wQFTyZa53C&amp;list=PLKueo-cldy_HjRnPUL4G3pWHS7FREAizF"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
        ...
        <p>
          ...
          Dashboards, and Multi-Cloud Serverless APIs. By the end of the
          quarter, the participants will be able to develop and deploy web
          ...
          tRPC, GraphQL, Prisma, Cockroachdb Serverless (PostgreSQL Compatible),
          AWS Serverless Technologies, and Cloud Development Kit for Terraform
          (CDKTF).
        </p>
        <p>Course Outline:</p>
        <h3>Next.js 13 Web Development</h3>
        <p>
        ...
        <h3>Next.js 13 using Chakra UI (Remote Zoom Class)</h3>
        ...
        <p>https://www.freecodecamp.org/news/css-flexbox-complete-guide/</p>
        <h3>
        ...
        <p>
          <a href="https://www.amazon.com/Designing-Prototyping-Interfaces-Figma-interactive/dp/180056418X/ref=sr_1_1_sspa">
            Designing and Prototyping Interfaces with Figma by Fabio Staiano
          </a>
        </p>
        <p>
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/5hzZtqCNQKk?si=rAs_OlwkWIbdQZRC"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        ...
        <h3>Next.js 13 using TailwindCSS (Remote Zoom Class)</h3>
        <p>
        ...
        <h3>AWS Application Composer (Remote Zoom Class)</h3>
        <div className="youtube-videos">
          <p>What is AWS Application Composer?</p>
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/BujE_tik5r8?si=2zrt1S1EFtmKQNpr"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/p411uh363jQ?si=1rryVxJN7fpP38p1"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/nzJsYJPCc80?si=_pvIM7QNLas-4Y-k"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        </div>
        <h3>Earn While You Learn Projects</h3>
        <h3>Build Full-Stack Next.js 13 Jamstack Templates</h3>
        <p>
        ...
        <h3>Quarter III Web3 and Metaverse</h3>
        <h3>
        ...
        <h3>Blockchain and Metaverse Theory</h3>
        <p>
        ...
        <h3>Smart Contract Development in Solidity</h3>
        <p>
        ...
        <h3>Dapp Development using Ethers.js and Next.js 13</h3>
        <p>
        ...
        <h2>Quarter IV Web3 and Metaverse</h2>
        <h2>
        ...
        <div className="youtube-videos">
          <p>Blender 3.0 Beginner Tutorial</p>
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/videoseries?si=mbHGZGjKVW643NEi&amp;list=PLjEaoINr3zgFX8ZsChQVQsuDSjEqdWMAD"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        ...
        <div className="youtube-videos">
          ...
          <iframe
            width="660"
            height="350"
            src="https://www.youtube.com/embed/H7T0SzdFHwg?si=zOH9JEoXzuBZ_mDm"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          ></iframe>
        ...
        <div id="heros-section">
          ...
          >
            <source src="assets/our hero.mp4" type="video/mp4" />
        ...
        <div className="container">
          ...
          <form>
            ...
            <select id="location" name="country">
